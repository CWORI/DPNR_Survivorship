...
The report and R script automatically find the project folder by looking for `config/outplant_interval_files.csv`, so users should not need to edit hard-coded working-directory paths.
...
- `config/outplant_interval_files.csv`: user-editable list of TagLab match files to analyze.
...
2. Add a matching row to `config/outplant_interval_files.csv`.
